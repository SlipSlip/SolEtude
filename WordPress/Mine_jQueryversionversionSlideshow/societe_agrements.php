<?php/*
Template Name: SocieteAgrements
*/?>
<!DOCTYPE html>
<html>
    <head>
						...
						<?php while (have_posts()) : the_post(); ?>
							<div id="post-content_societe">
								<ul id="tabs">
									...
									<li><a href="http://localhost/wordpress/?page_id=674" id="onglet_tab_actif">    Agréments  </a></li>
									<li><a href="http://localhost/wordpress/?page_id=677" id="onglet_tab_inactif_tab3">          Equipe   </a></li>
								</ul>
								<div id="content"> 
								<div id="tab2">
								<p><nav id="entreprise_agre"></nav></p>
